package Validation.PasswordValidation;
...
public class Model{
	...
	private static final int maxChar = 32;
	private static final int minChar = 7;
	...
	public static String evaluatePassword(String input) {
		...
		while (running) {
			...
			if (currentCharNdx >= minChar) {
				System.out.println("At least 8 characters found");
				foundLongEnough = true;
			}
			if (currentCharNdx > maxChar){
				System.out.println("The password exceed the maximum characters");
				foundTooLong = true;
			}
