...
public class PasswordEvaluationGUITestbed {

	private static String string_ApplicationTitle = new String("Specify Your Password");
	...
	public static void displayPasswordEvaluationGUITestbed() {
