...
public class ViewAdminHome {
    ...
    */
    ...
    protected static Button button_RequestCenter = new Button("Request Center");
    ...
    */
    ...
    private ViewAdminHome() {
        ...
        List<String> list = new ArrayList<String>();    // Create a new empty list of the
        ...
        setupButtonUI(button_RequestCenter, "Dialog", 16, 250, Pos.CENTER, 300, 270);
        button_RequestCenter.setOnAction((_) -> { ControllerAdminHome.viewRequestCenter(); });
